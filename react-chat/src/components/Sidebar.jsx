...
export const Sidebar = ({onClick,logOut}) => {
    ...
    const [holdChat, setHoldChat] = useState([]);
    const [Load,setLoad] = useState(true);
     ...
     return  (
         <motion.div
             ...
             <input type={"button"} value={'VIEW'} onClick={() => history.push("/viewer")} className={`shadow-2xl font-mono absolute top-[13em] h-fit w-[90%] py-2 bg-blue-700 rounded-xl`}/>
