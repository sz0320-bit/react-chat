            ...
            <motion.div
                ...
                <div className={`absolute`}>
                    ...
                    <div className={"h-fit p-8  w-screen flex justify-center items-center  gap-5 flex-col"}>
                        ...
                        <input type={"button"} value={'TEXT'} onClick={textReroute} className={`shadow-2xl font-mono max-w-[15em] top-[9em] h-fit w-[50%] py-2 bg-blue-700 text-white rounded-xl`}/>
                        <div className={`flex justify-center gap-2 rounded-2xl flex-col items-center  p-2`}>
                            <div className={'font-mono '}>UserID:</div>
                            <div className={`text-md border primary shadow-2xl p-2 rounded-2xl`}>{match.params.id}</div>
                        </div>
                    </div>
                </div>
